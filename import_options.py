...
file_path = "Answers_data_prj3_2.csv"
...
file_name = "Answers_data_prj3_2_modified.csv"
...
reader = csv.DictReader(open('Answers_data_prj3_2_modified.csv'))
...
for item in final_correct_answer_list:
	...
	if i%2 == 0:
		...
		final_csv_dict_array[i/2]["Correct_option"] = 1
	else:
...
# for new_item in final_incorrect_answer_list:
# 	if final_csv_dict[i]["Correct_option"] == 1:
# 		final_csv_dict[i]["Option2"] = new_item["Answer_text"]
...
# for item in final_correct_answer_list:
# 	if(i%2 ==1):
# 		correct_option_id = final_csv_dict["Correct_option"]
# 		final_csv_dict[correct_option_id] = item["Answer_text"]
...
question_reader = csv.DictReader(open('Questions_data_prj3_2.csv'))
...
with open('FinalOutput2.csv', 'wb') as output_file:
...
with open('FinalQuizzitOutput2.csv', 'wb') as output_file:
